...
abstract class FormatPattern {
   ...
   */
  @Nullable abstract String convert(ParsePosition parsePosition, String formatString,
      ZonedDateTime dateTime);

  @Nullable abstract ChronoUnitEnum getChronoUnit();

  long parse(ParsePosition inputPosition, String input, ParsePosition formatPosition,
  ...
  abstract long parseValue(ParsePosition inputPosition, String input, Locale locale,
