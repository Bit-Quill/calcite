...
public class YearWithCommasFormatPattern extends StringFormatPattern {
  ...
  @Override long parseValue(final ParsePosition inputPosition, final String input,
    ...
    return Long.parseLong(thousands) * 1000L + Long.parseLong(remainingDigits);
  }

  @Override String dateTimeToString(final ZonedDateTime dateTime, final boolean haveFillMode,
