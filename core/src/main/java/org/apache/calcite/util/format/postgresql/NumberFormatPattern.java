 ...
 */
class NumberFormatPattern extends FormatPattern {
  @Nullable
  ...
  protected NumberFormatPattern(@Nullable ChronoUnitEnum chronoUnit, long minValue,
      long maxValue, int preferredLength, Function<ZonedDateTime, String> converter,
      String... patterns) {
  ...
  @Override long parseValue(final ParsePosition inputPosition, final String input,
    ...
    long value = Long.parseLong(input.substring(inputPosition.getIndex(), endIndex));
